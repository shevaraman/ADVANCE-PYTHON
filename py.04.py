...
l2 = Label(f2, text="STUDENT INFORMATION", bg="pink", fg="black", font=("Arial", 16))
l2.pack(pady=10)
...
l5 = Label(root, text="DATA OF BIRTH")  
l5.pack()

e6 = Entry(root)
e6.pack()

l7 = Label(root, text="ADDRESS OF COMMUNICTION")  
l7.pack()

e8 = Entry(root)
e8.pack()

l9= Label(root, text="PHONE NO")  
l9.pack()
